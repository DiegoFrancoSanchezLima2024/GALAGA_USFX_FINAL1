...
//detruye a la nave enemiga Nodridriza
void AGALAGA_USFX_L01Projectile::DestruirNaveEnemigaNodriza()
{
	ANaveEnemigaNodriza* NaveEnemigaNodriza = Cast<ANaveEnemigaNodriza>(GetOwner());
	if (NaveEnemigaNodriza)
	{
		NaveEnemigaNodriza->Destroy();
	}
}